  ...
  function startHomeTutorial() {
    ...
    void (async () => {
      try {
        ...
        console.error('[Tutorial] Failed to start home tutorial:', e)
      }
    })()
  }
  ...
  function startInteractionTutorial() {
    ...
    void (async () => {
      try {
        ...
        console.error('[Tutorial] Failed to start interaction tutorial:', e)
      }
    })()
  }
  ...
  function startSidebarTutorial() {
    ...
    void (async () => {
      try {
        ...
        console.error('[Tutorial] Failed to start sidebar tutorial:', e)
      }
    })()
  }
